...
cp "files/5.15.76-v7l+/dm-verity.ko" "${ROOTFS_DIR}/lib/modules/5.15.76-v7l+/kernel/drivers/md/"
cp "files/5.15.76-v7l+/*.dtbo" "${ROOTFS_DIR}/boot/overlays/"

on_chroot <<EOF
depmod -a 5.15.76-v7l+
